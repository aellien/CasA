...
path_bxa     = '/n03data/ellien/CasA/tests/out3/acis_bxa_test_3x3_freeab_8core_step10_unbin_vnei/'
...
infilename = 'spec_test_bayes_3x3arcsec.pi'
...
results = solver.run( resume = 'overwrite', log_dir = os.path.join( path_bxa, 'logs' ), speed = 10, frac_remain = 0.5, max_num_improvement_loops = 0 )
