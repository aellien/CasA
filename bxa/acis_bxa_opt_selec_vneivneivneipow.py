...
path_bxa = '/n03data/ellien/CasA/tests/out3/acis_bxa_test_powvnei/'
...
# xspec model
xs.AllModels.clear()
model_name = 'Tbabs(vnei+vnei+vnei+pow)'
...
list_input_par  = [ [     0.7, 0.001,    0.1,    0.1,    4.0,   4.0 ],
                  ...
                  [    2e+03,  0.01,  1e+02,  1e+02,  1e+05, 1e+05 ],
                  [    2e+02,  0.01,  1e+02,  1e+02,  1e+05, 1e+05 ],
                  ...
                  [    1e-07,  0.01,  1e-10,  1e-10,  1e-05, 1e-05 ],
                  [      2.0,  0.01,    0.1,    0.1,  5e+00, 5e+00 ],
                  [        1,  0.01,  1e-01,  1e-01,  1e+05, 1e+05 ],
                  [        1,  0.01,  1e-01,  1e-01,  1e+05, 1e+05 ],
                  [        1,  0.01,  1e-01,  1e-01,  1e+05, 1e+05 ],
                  ...
                  [        0,  0.01,      0,      0,  1e+03, 1e+03 ],
                  [        0,  0.01,      0,      0,  1e+03, 1e+03 ],
                  [    1e+04,  0.01,  1e-01,  1e-01,  1e+03, 1e+03 ],
                  ...
                  [    1e-06,  0.01,  1e-07,  1e-07,  1e-05, 1e-05 ] ]
...
transformations = []
for k in range( 1, model.nParameters + 1 ):
    if k in [ 8, 9, 16, 18, 28, 29, 30, 33, 34, 50, 52, 54 ]:
