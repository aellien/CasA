...
path_bxa     = '/n03data/ellien/CasA/analysis/out11/synth_bxa_spec4x4_within25x25_vneivneipownei_%s/' %num_reg
...
# xspec model
xs.AllModels.clear()
model_name = 'Tbabs(vnei+vnei+pow+nei)'
...
#  36    4   powerlaw   PhoIndex            1.00000      +/-  0.0
#  37    4   powerlaw   norm                1.00000      +/-  0.0
#  38    5   nei        kT         keV      1.00000      +/-  0.0
#  39    5   nei        Abundanc            1.00000      frozen
#  40    5   nei        Tau        s/cm^3   1.00000E+11  +/-  0.0
#  41    5   nei        Redshift            0.0          frozen
#  42    5   nei        norm                1.00000      +/-  0.0
#________________________________________________________________________
...
transformations = []
for k in range( 1, model.nParameters + 1 ):
    if k in [ 2, 5, 6, 7, 8, 9, 10, 11, 12, 13, 16, 18, 19, 31, 32, 33, 35, 37, 38, 39, 40, 42 ]:
