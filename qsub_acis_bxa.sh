#!/bin/bash
#PBS -o /home/ellien/CasA/logs/log_acis_bxa_${spec}_${mod}.log
#PBS -j oe
#PBS -N bxa
...
mpiexec -n 8 ipython /home/ellien/CasA/CasA/bxa/synth_bxa_opt_selec_${mod}.py ${spec}
#mpiexec -n 8 ipython /home/ellien/CasA/CasA/bxa/acis_bxa_opt_selec_${mod}.py ${spec}
